...
<head>
  ...
  <title>Accountant Digital</title>
...
<div id="content">
  ...
  <!-- End of Topbar -->
    ...
    <!-- Begin Page Content -->
         ...
         <div class="section">
            <h2 class="text-center">Accountant Digital</h2>
         </div>
         
            <div class="card mb-3 col-lg-12 col-md-6">
                
                    <img src="<?php  base_url() ?>assets/img/conta.jpg" class="mx-auto d-block" />
        ...
        <script src="<?php echo base_url()?>assets/js/sb-admin-2.min.js"></script>
            ...
            <footer class="sticky-footer bg-white">
                ...
                <div class="copyright text-center my-auto">
                    <span>Copyright &copy; accountant digital</span>
                </div>
                </div>
            </footer>
            <!-- End of Footer -->
